...
# switch / button
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33 PULLUP true} [get_ports {reset_n}]
...
#pmod a - gpios
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports {led[0]}]
set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVCMOS33} [get_ports {led[1]}]
...
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {led[4]}]
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVCMOS33} [get_ports {led[5]}]
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports {led[6]}]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports {led[7]}]
# end

## pmod b, rotary switch
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 PULLUP true} [get_ports { switch[0] }]; 
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 PULLUP true} [get_ports { switch[1] }]; 
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS33 PULLUP true} [get_ports { switch[2] }]; 
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 PULLUP true} [get_ports { switch[3] }]; 

#########################################################
# Clock (33.333 MHz)                                       #
#########################################################
set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33} [get_ports {sys_clk}]
create_clock -period 30.0 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports sys_clk]
...
# J5 UART interface
##################################
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33 } [get_ports {rs232_rxd}]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33 } [get_ports {rs232_txd}]
# pmod 6&7
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports {uart_rts}]
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports {uart_cts}]
